...
public class LoginService {
	...
	public static void initFewUsers() {
		...
		users.put("planon1", new User("Sai", 23, "planon1", "planon123",100));
		users.put("planon2", new User("Sai", 23, "planon2", "planon123",100));
		users.put("planon3", new User("Sai", 23, "planon3", "planon123",100));
		users.put("planon4", new User("Sai", 23, "planon4", "planon123",100));
	}
